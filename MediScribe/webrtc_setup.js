const socket = io.connect('https://0f51-2405-201-c009-f236-f0a5-c1eb-7104-c0da.ngrok-free.app'); // Replace with your server URL
...
socket.on('endCall', (data) => {
  ...
  // Display the prescription modal with the formatted prescription
  prescriptionModal.style.display = 'flex';
  prescriptionText.innerText = `Prescription:\n${data.prescription}`;
});
